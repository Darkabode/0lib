 ...
 */
#define pk_rsa( pk )        ( (rsa_context_t *) (pk).pk_ctx )
...
typedef struct
{
    ...
    /** Decrypt message */
    int (*decrypt_func)( void *ctx, const uint8_t *input, size_t ilen,
                         uint8_t *output, size_t *olen, size_t osize,
                         int (*f_rng)(void *, uint8_t *, size_t),
                         void *p_rng );

    /** Encrypt message */
    int (*encrypt_func)( void *ctx, const uint8_t *input, size_t ilen,
                         uint8_t *output, size_t *olen, size_t osize,
                         int (*f_rng)(void *, uint8_t *, size_t),
                         void *p_rng );
 ...
 *                  error code
 */
int pk_write_key_der( pk_context *ctx, uint8_t *buf, size_t size );
 ...
 *                  error code
 */
int pk_write_pubkey_der( pk_context *ctx, uint8_t *buf, size_t size );
 ...
 */
int pk_write_pubkey_pem( pk_context *ctx, uint8_t *buf, size_t size );
 ...
 * \return          0 successful, or a specific error code
 */
int pk_write_key_pem( pk_context *ctx, uint8_t *buf, size_t size );
 ...
 */
int pk_write_pubkey( uint8_t **p, uint8_t *start,
