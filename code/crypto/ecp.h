...
typedef struct
{
    mpi_t X;          /*!<  the point's X coordinate  */
    mpi_t Y;          /*!<  the point's Y coordinate  */
    mpi_t Z;          /*!<  the point's Z coordinate  */
}
ecp_point;
 ...
 * Otherwise, it must point to a function that takes an mpi_t in the range
...
typedef struct
{
    ...
    mpi_t P;              /*!<  prime modulus of the base field               */
    mpi_t A;              /*!<  1. A in the equation, or 2. (A + 2) / 4       */
    mpi_t B;              /*!<  1. B in the equation, or 2. unused            */
    ecp_point G;        /*!<  generator of the (sub)group used              */
    mpi_t N;              /*!<  1. the order of G, or 2. unused               */
    size_t pbits;       /*!<  number of bits in P                           */
    size_t nbits;       /*!<  number of bits in 1. P, or 2. private keys    */
    uint32_t h;     /*!<  internal: 1 if the constants are static       */
    int (*modp)(mpi_t *); /*!<  function for fast reduction mod P             */
...
/**
 * \brief           Check that an mpi_t is a valid private key for this curve
 *
